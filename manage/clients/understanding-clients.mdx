...
Use [Install Client](/manage/clients/install-client) for people logging in with accounts, and [Machine Clients](/manage/clients/manage-machine-clients) for automated systems and servers.
...
<CardGroup cols={2}>
<Card title="User Devices" href="/manage/clients/install-client">
...
<Card title="Machines" href="/manage/clients/manage-machine-clients">
